...
def method():
	os.system('clear')
	print(logo)
	print('[1] Method1 Fast [\x1b[1;92mBest freefb\x1b[1;97m] ')
	print('[2] Method2 Fast [\x1b[1;92mBest mbasic\x1b[1;97m] ')
	print('[3] Method3 Fast [\x1b[1;92mFast m.fb\x1b[1;97m] ')
	print('[0] Back')
	print(47*'-')
	opt = input('[?] Choose : ')
	if opt =='1':
